...
<html>
	...
	<body class="hold-transition sidebar-mini">
		<div class="wrapper">
			<jsp:include page="/WEB-INF/views/seller/include/header.jsp"/>
		    <jsp:include page="/WEB-INF/views/seller/include/sidebar.jsp"/>
		    <jsp:include page="/WEB-INF/views/${contentPage}" />
		    <jsp:include page="/WEB-INF/views/seller/include/footer.jsp"/>
	  	</div>
	  		<!-- jQuery / jQuery UI -->
