			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item has-treeview">
					<a href="#" class="nav-link">
						...
						<p>상품 관리<i class="right fas fa-angle-left"></i>
						</p>
					</a>
				...
				<li class="nav-item has-treeview">
					<a href="#" class="nav-link">
						...
						<p>주문 관리<i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
				...
				<li class="nav-item has-treeview">
					<a href="#" class="nav-link">
						...
						<p>리뷰&문의 관리<i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
				...
				<li class="nav-item has-treeview">
					<a href="#" class="nav-link">
						...
						<p>스토어 관리<i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
				...
				<li class="nav-item has-treeview">
					<a href="#" class="nav-link">
						...
						<p>이벤트 관리<i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
				...
				<li class="nav-item has-treeview">
					<a href="#" class="nav-link">
						...
						<p>정산 관리<i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
